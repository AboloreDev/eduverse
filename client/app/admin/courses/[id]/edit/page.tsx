...
import { CourseFormData, courseLevels, courseStatus } from "@/lib/schemas";
import { useEditCourseMutation } from "@/state/api/courseApi";
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-slate-500">
                          Detailed description that will appear on the course
                          page
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-slate-500">
                          Short summary displayed in course listings and
                          previews
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
